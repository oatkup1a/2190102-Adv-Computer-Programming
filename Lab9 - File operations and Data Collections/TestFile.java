...
public class TestFile {
    public static void main(String[] args) {
        ...
        HashMap<String, int[]> allScores = testFile.read_scores("C:\\Coding\\Adv ComProg\\LastLab\\src\\student_scores.csv");
        ...
        HashSet<String> editedStudentIDs = testFile.getEditedStudentID("C:\\Coding\\Adv ComProg\\LastLab\\src\\edited_scores.csv");
        System.out.println("Edited Student IDs: " + editedStudentIDs);

        // Task 4: Test the 'createNewEditedScore' method
        testFile.createNewEditedScore("C:\\Coding\\Adv ComProg\\LastLab\\src\\student_scores.csv", 
        "C:\\Coding\\Adv ComProg\\LastLab\\src\\student_scores.csv", "new_scores.csv");
